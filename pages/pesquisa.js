...
Por isso, estamos sempre abertos a ouvir a sua opinião.</p>
            ...
            {sucess && <div className="w-1/5 mx-auto">
                <p className="mb-6 text-center bg-blue-100 border-t border-b border-blue-500 text-blue-70 px-4 py-3">Obrigado por contribuir com sua sugestão ou crítica.</p>
                {
                ...
                }
                {
                    retorno.showCoupon && <div className="text-center border p-4 mb-4">
                        ...
                        Tire um print ou foto desta tela e apresenta ao garçon.
                        </span>
                    </div>    
                }
                </div>}
